...
namespace DeltaWorkMonitoring.Migrations
{
    ...
    [Migration("20170408183432_Initial")]
    partial class Initial
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("DeltaWorkMonitoring.Models.Task", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DeltaWorkMonitoring.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("DeltaWorkMonitoring.Models.Task", b =>
                {
                    b.HasOne("DeltaWorkMonitoring.Models.Task", "Parent")
                        .WithMany("Tasks")
                    ...
                    b.HasOne("DeltaWorkMonitoring.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("DeltaWorkMonitoring.Models.TaskHistoryItem", b =>
                {
                    b.HasOne("DeltaWorkMonitoring.Models.Task", "Task")
